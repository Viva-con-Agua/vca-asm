...
class VCA_ASM {
	...
	public function vca_asm_admin_enqueue() {
		...
		wp_register_script( 'vca-asm-admin-dialog', VCA_ASM_RELPATH . 'js/admin-dialog.js', array( 'jquery', 'jquery-ui-dialog' ), '2015.06.05.75', true );
		...
		wp_register_style( 'vca-asm-admin-generic-style', VCA_ASM_RELPATH . 'css/admin-generic.css', false, '2015.6.7.70' );
