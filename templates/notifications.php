...
/**
 * Template for the text/html part of an automatic response
 *
 **/
...
$for = ( ! empty( $receipient_group ) ) ? $receipient_group : __( 'Supporter', 'vca-asm' );
if( ! isset( $append ) ) {
	$append = '';
}
$lf = "\n";
